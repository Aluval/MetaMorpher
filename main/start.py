...
async def help(bot, msg):
   txt = (
       "Sᴇɴᴅ ᴀ ғɪʟᴇ ᴀɴᴅ /rename <new name> ᴡɪᴛʜ ʀᴇᴘʟᴀʏᴇᴅ ʏᴏᴜʀ ғɪʟᴇ\n\n"
       "Rᴇɴᴀᴍᴇ [#𝟸GB] Bᴇʟᴏᴡ - Tᴇʟᴇɢʀᴀᴍ [#𝟸GB] Aʙᴏᴠᴇ - Gᴏᴏɢʟᴇ Dʀɪᴠᴇ - Rᴇɴᴀᴍᴇ ғɪʟᴇꜱ\n\n"
       "Mᴇᴛᴀᴅᴀᴛᴀ - Mᴏᴅɪғʏ ᴍᴇᴛᴀᴅᴀᴛᴀ\n\nFᴏʀᴍᴀᴛ: ᴄʜᴀɴɢᴇᴍᴇᴛᴀᴅᴀᴛᴀ ᴠɪᴅᴇᴏ_ᴛɪᴛʟᴇ | ᴀᴜᴅɪᴏ_ᴛɪᴛʟᴇ | ꜱᴜʙᴛɪᴛʟᴇ_ᴛɪᴛʟᴇ\n\n"
       "Gᴏғɪʟᴇ - Tʜᴇ Fɪʟᴇs Uᴘʟᴏᴀᴅ Tᴏ Gᴏғɪʟᴇ Lɪɴᴋ 🔗\n\n"
       "ɢᴏғɪʟᴇsᴇᴛᴜᴘ - Sᴇᴛᴜᴘ Tʜᴇ Gᴏғɪʟᴇ API KEY ғʀᴏᴍ Gᴏғɪʟᴇ.ɪᴏ ⚙️\n\n"
       "ɢᴅʀɪᴠᴇɪᴅ - Tʜᴇ Gᴏᴏɢʟᴇ Dʀɪᴠᴇ Fᴏʟᴅᴇʀ ID Sᴇᴛᴜᴘ 📁.\n\n"
       "Mɪʀʀᴏʀ - Mɪʀʀᴏʀ ғɪʟᴇs ᴛᴏ ᴀ Gᴏᴏɢʟᴇ Dʀɪᴠᴇ ʟɪɴᴋ.\n\n"
       "Cʟᴏɴᴇ -  Cʟᴏɴᴇ ᴀ Gᴏᴏɢʟᴇ Dʀɪᴠᴇ ʟɪɴᴋ.\n\n"
       "Lɪsᴛ - Cʜᴇᴄᴋ ᴛʜᴇ ғɪʟᴇs ɪɴ Gᴏᴏɢʟᴇ Dʀɪᴠᴇ ᴠɪᴀ ᴛʜᴇ ʙᴏᴛ.\n\n"
       "Cʟᴇᴀɴ - Dᴇʟᴇᴛᴇ ғɪʟᴇs ɪɴ Gᴏᴏɢʟᴇ Dʀɪᴠᴇ ʙʏ ғɪʟᴇ ɴᴀᴍᴇ.\n\n"
       "ʟᴇᴇᴄʜ - ʟᴇᴇᴄʜ ᴛʜᴇ Sᴇᴇᴅʀ & Wᴏʀᴋᴇʀs' Lɪɴᴋs ᴛᴏ Fɪʟᴇ ᴏʀ Gᴅʀɪᴠᴇ.\n\n"
       "Exᴛʀᴀᴄᴛ Aᴜᴅɪᴏs - Exᴛʀᴀᴄᴛ ᴀᴜᴅɪᴏ ғʀᴏᴍ ғɪʟᴇs.\n\n"
       "Exᴛʀᴀᴄᴛ Sᴜʙᴛɪᴛʟᴇs - Exᴛʀᴀᴄᴛ sᴜʙᴛɪᴛʟᴇs ғʀᴏᴍ ғɪʟᴇs.\n\n"
       "Exᴛʀᴀᴄᴛ Vɪᴅᴇᴏs - Exᴛʀᴀᴄᴛ ᴠɪᴅᴇᴏ ғʀᴏᴍ ғɪʟᴇs.\n\n"
       "Cʜᴀɴɢᴇɪɴᴅᴇxᴀᴜᴅɪᴏ - Rᴇᴀʀʀᴀɴɢᴇ ᴛʜᴇ ɪɴᴅᴇx\n\nFᴏʀᴍᴀᴛ:1)a-𝟷 ғᴏʀ ʀᴇᴍᴏᴠᴇ ᴀᴜᴅɪᴏ\n2)a-𝟸-𝟷-𝟹-𝟺 ғᴏʀ ꜱᴡᴀᴘ ᴀᴜᴅɪᴏ\n\n"
       "Cʜᴀɴɢᴇɪɴᴅᴇxsᴜʙ - Rᴇᴏʀᴅᴇʀ ᴛʜᴇ sᴇǫᴜᴇɴᴄᴇ [s-𝟷  ғᴏʀ ʀᴇᴍᴏᴠᴇ sᴜʙᴛɪᴛʟᴇ, s-𝟸-𝟷-𝟹-𝟺 ғᴏʀ sᴡᴀᴘ sᴜʙᴛɪᴛʟᴇ]\n\n"
       "Gᴇɴᴇʀᴀᴛᴇ Sᴀᴍᴘʟᴇ Vɪᴅᴇᴏ - Cʀᴇᴀᴛᴇ ꜱᴀᴍᴘʟᴇ ᴠɪᴅᴇᴏꜱ (𝟹𝟶ꜱ, 𝟼𝟶ꜱ, 𝟿𝟶ꜱ, 𝟷𝟸𝟶ꜱ, 𝟷𝟻𝟶ꜱ)\n\n"
       "Sᴄʀᴇᴇɴꜱʜᴏᴛꜱ - Tᴀᴋᴇ ꜱᴄʀᴇᴇɴꜱʜᴏᴛꜱ (ᴇxᴀᴍᴘʟᴇ: /ꜱᴄʀᴇᴇɴꜱʜᴏᴛꜱ 𝟷𝟶)\n\n"
       "Uɴᴢɪᴘ ᴛʜᴇ Fɪʟᴇꜱ ᴏɴʟʏ ᴢɪᴘ Fᴏʀᴍᴀᴛ ᴏɴʟʏ - Exᴛʀᴀᴄᴛ ZIP ғɪʟᴇꜱ ᴏɴʟʏ\n\n"
       "Aᴛᴛᴀᴄʜ Pʜᴏᴛᴏ ɪꜱ ᴜꜱᴇᴅ ᴀᴛᴛᴀᴄʜᴍᴇɴᴛ.ɪᴘɢ ᴛᴏ ᴀ ғɪʟᴇ\n\n"
       "ꜱᴇᴛᴘʜᴏᴛᴏ -  Tᴏ ᴀᴅᴅ ᴀ ᴘʜᴏᴛᴏ ᴛᴏ ᴀ ғɪʟᴇ  ᴀᴛᴛᴀᴄʜᴍᴇɴᴛ.ɪᴘɢ ғᴏʀ ꜱᴇɴᴅɪɴɢ ᴛʜᴇ ᴘʜᴏᴛᴏ ᴀꜱ ᴀɴ ᴀᴛᴛᴀᴄʜᴍᴇɴᴛ.\n\n"
       "ᴍᴇʀɢᴇ  - Sᴇɴᴅ ᴜᴘ ᴛᴏ 𝟷𝟶 ᴠɪᴅᴇᴏ/ᴅᴏᴄᴜᴍᴇɴᴛ ғɪʟᴇs ᴏɴᴇ ʙʏ ᴏɴᴇ.\n\n"
       "ᴠɪᴅᴇᴏᴍᴇʀɢᴇ - Vɪᴅᴇᴏᴍᴇʀɢᴇ ᴡɪᴛʜ ғɪʟᴇɴᴀᴍᴇ.ᴍᴋᴠ ᴛᴏ sᴛᴀʀᴛ ᴍᴇʀɢɪɴɢ\n\n"
       "Mᴜʟᴛɪᴛᴀsᴋ - Mᴜʟᴛɪᴛᴀsᴋ ɪs Cʜᴀɴɢᴇᴍᴇᴛᴅᴀᴛᴀ + Tʜᴜᴍʙɴᴀɪʟ\n\n"
       "RᴇᴍᴏᴠᴇTᴀɢs - Tᴏ Rᴇᴍᴏᴠᴇ Aʟʟ Mᴇᴛᴀᴅᴀᴛᴀ Tᴀɢs\n\n"
       "ꜱᴇɴᴅ ᴘʜᴏᴛᴏ ᴛᴏ ꜱᴇᴛ ᴛʜᴜᴍʙɴᴀɪʟ ᴀᴜᴛᴏᴍᴀᴛɪᴄ🌟\n\n"
       "/view ᴛᴏ ꜱᴇᴇ ʏᴏᴜʀ ᴛʜᴜᴍʙɴᴀɪʟ 👀\n\n"
       "/del ᴛᴏ ᴅᴇʟᴇᴛᴇ ʏᴏᴜʀ ᴛʜᴜᴍʙɴᴀɪʟ❌\n\n"
       "Jᴏɪɴ : @Sunrises24BotUpdates"
     )
    button= [[        
